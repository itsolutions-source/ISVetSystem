...
@Component({
    ...
    template: `
        <div class="flex flex-col gap-4">
            <div>
                <span class="text-sm text-muted-color font-semibold">Cores dos botões</span>
            ...
            <div>
                <span class="text-sm text-muted-color font-semibold">Cores de fundo</span>
                <div class="pt-2 flex gap-2 flex-wrap justify-start">
            ...
            <div class="flex flex-col gap-2">
                <span class="text-sm text-muted-color font-semibold">Estilos</span>
                <p-selectbutton [options]="presets" [ngModel]="selectedPreset()" (ngModelChange)="onPresetChange($event)" [allowEmpty]="false" size="small" />
            </div>
            <div *ngIf="showMenuModeButton()" class="flex flex-col gap-2">
                <span class="text-sm text-muted-color font-semibold">Estilo de menu</span>
